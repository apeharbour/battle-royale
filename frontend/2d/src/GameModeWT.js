...
import MapAbi from './abis/MapWT.json'
import GameAbi from './abis/GameWT.json'
  ...
  return (
    <Container>
      <Grid container spacing={4} mt={4}>
        <Grid item xs={12}>
          <Typography variant='h3'>Battle Royale - with Yacht Traits</Typography>
        </Grid>
