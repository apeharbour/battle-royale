...
export class GameWOT__addShipResultValue0Struct extends ethereum.Tuple {
  get coordinate(): GameWOT__addShipResultValue0CoordinateStruct {
    return changetype<GameWOT__addShipResultValue0CoordinateStruct>(
      this[0].toTuple()
    );
  }
  ...
  get yachtSpeed(): BigInt {
    return this[7].toBigInt();
  }

  get yachtRange(): BigInt {
    return this[8].toBigInt();
  }
}

export class GameWOT__addShipResultValue0CoordinateStruct extends ethereum.Tuple {
  get q(): i32 {
    return this[0].toI32();
  }
...
export class GameWOT__gamesResult {
  value0: BigInt;
  value1: i32;
  value2: boolean;
  value3: boolean;
...
export class GameWOT__getCellResultValue0Struct extends ethereum.Tuple {
  get q(): i32 {
    return this[0].toI32();
  }
...
export class GameWOT__getCellInput_coordStruct extends ethereum.Tuple {
  get q(): i32 {
    return this[0].toI32();
  }
...
export class GameWOT__getCellsResultValue0Struct extends ethereum.Tuple {
  get q(): i32 {
    return this[0].toI32();
  }
...
export class GameWOT__getShipsResultValue0Struct extends ethereum.Tuple {
  get coordinate(): GameWOT__getShipsResultValue0CoordinateStruct {
    return changetype<GameWOT__getShipsResultValue0CoordinateStruct>(
      this[0].toTuple()
    );
  }
...
export class GameWOT__getShipsResultValue0CoordinateStruct extends ethereum.Tuple {
  get q(): i32 {
    return this[0].toI32();
  }
...
export class GameWOT__moveResultValue0Struct extends ethereum.Tuple {
  get q(): i32 {
    return this[0].toI32();
  }
...
export class GameWOT__moveInput_startStruct extends ethereum.Tuple {
  get q(): i32 {
    return this[0].toI32();
  }
...
export class GameWOT extends ethereum.SmartContract {
  static bind(address: Address): GameWOT {
    return new GameWOT("GameWOT", address);
  }
  ...
  addShip(
    ...
    return changetype<GameWOT__addShipResultValue0Struct>(result[0].toTuple());
  }
  ...
  try_addShip(
    ...
    return ethereum.CallResult.fromValue(
      changetype<GameWOT__addShipResultValue0Struct>(value[0].toTuple())
    );
  }

  games(param0: BigInt): GameWOT__gamesResult {
    let result = super.call(
      "games",
    ...
    return new GameWOT__gamesResult(
      result[0].toBigInt(),
      result[1].toI32(),
      result[2].toBoolean(),
      result[3].toBoolean(),
  ...
  try_games(param0: BigInt): ethereum.CallResult<GameWOT__gamesResult> {
    let result = super.tryCall(
      "games",
      "games(uint256):(uint256,uint8,bool,bool,bool,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
  ...
  getCell(
    _coord: GameWOT__getCellInput_coordStruct,
    gameId: i32
  ): GameWOT__getCellResultValue0Struct {
    let result = super.call(
      "getCell",
    ...
    return changetype<GameWOT__getCellResultValue0Struct>(result[0].toTuple());
  }

  try_getCell(
    _coord: GameWOT__getCellInput_coordStruct,
    gameId: i32
  ): ethereum.CallResult<GameWOT__getCellResultValue0Struct> {
    let result = super.tryCall(
      "getCell",
      "getCell((uint8,uint8),uint8):((uint8,uint8,bool,bool))",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<GameWOT__getCellResultValue0Struct>(value[0].toTuple())
    );
  }

  getCells(gameId: i32): Array<GameWOT__getCellsResultValue0Struct> {
    let result = super.call("getCells", "getCells(uint8):((uint8,uint8)[])", [
      ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(gameId))
    ]);

    return result[0].toTupleArray<GameWOT__getCellsResultValue0Struct>();
  }

  try_getCells(
    gameId: i32
  ): ethereum.CallResult<Array<GameWOT__getCellsResultValue0Struct>> {
    let result = super.tryCall(
      "getCells",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<GameWOT__getCellsResultValue0Struct>()
    );
  }
  ...
  getShips(gameId: i32): Array<GameWOT__getShipsResultValue0Struct> {
    let result = super.call(
      "getShips",
      "getShips(uint8):(((uint8,uint8),uint8,uint8,uint8,uint8,bool,address,uint256,uint256)[])",
      [ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(gameId))]
    );

    return result[0].toTupleArray<GameWOT__getShipsResultValue0Struct>();
  }

  try_getShips(
    gameId: i32
  ): ethereum.CallResult<Array<GameWOT__getShipsResultValue0Struct>> {
    let result = super.tryCall(
      "getShips",
      "getShips(uint8):(((uint8,uint8),uint8,uint8,uint8,uint8,bool,address,uint256,uint256)[])",
      [ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(gameId))]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<GameWOT__getShipsResultValue0Struct>()
    );
  }

  move(
    _start: GameWOT__moveInput_startStruct,
    _dir: i32,
    _distance: i32,
    gameId: i32
  ): GameWOT__moveResultValue0Struct {
    let result = super.call(
      "move",
    ...
    return changetype<GameWOT__moveResultValue0Struct>(result[0].toTuple());
  }
  ...
  try_move(
    ...
    _distance: i32,
    gameId: i32
  ): ethereum.CallResult<GameWOT__moveResultValue0Struct> {
    let result = super.tryCall(
      "move",
      "move((uint8,uint8),uint8,uint8,uint8):((uint8,uint8))",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<GameWOT__moveResultValue0Struct>(value[0].toTuple())
    );
  }
...
export class AddShipCall__Outputs {
  ...
  get value0(): AddShipCallValue0Struct {
    return changetype<AddShipCallValue0Struct>(
      this._call.outputValues[0].value.toTuple()
    );
  }
}

export class AddShipCallValue0Struct extends ethereum.Tuple {
  get coordinate(): AddShipCallValue0CoordinateStruct {
    return changetype<AddShipCallValue0CoordinateStruct>(this[0].toTuple());
  }
...
export class AddShipCallValue0CoordinateStruct extends ethereum.Tuple {
  get q(): i32 {
    return this[0].toI32();
  }
