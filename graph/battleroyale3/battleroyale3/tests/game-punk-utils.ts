...
export function createIslandEvent(gameId: i32, q: i32, r: i32): Island {
  let islandEvent = changetype<Island>(newMockEvent())

  islandEvent.parameters = new Array()

  islandEvent.parameters.push(
    new ethereum.EventParam(
      "gameId",
      ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(gameId))
    )
