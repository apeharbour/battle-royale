...
async function main() {
  // Replace this with the actual ABI
   const contractAbi = [
    ...
    {
      "inputs": [],
      "name": "revealedCollectionBaseURL",
      "outputs": [
        {
          "internalType": "string",
          "name": "",
    ...
    },
    {
      ...
      "name": "setRevealedCollectionBaseURL",
      "outputs": [],
      "stateMutability": "nonpayable",
      "type": "function"
    },
  ...
  const contractAddress = "0x24d0cbD0D5D7b50212251c5dc7cb810E7aF71F6a";
  const contract = new ethers.Contract(contractAddress, contractAbi, owner);

  // Replace this with the actual owner's address
  const ownerAddress = "0xCd9680dd8318b0df924f0bD47a407c05B300e36f";

  // Query the token ID for the owner's address
  const tokenId = await contract.tokenOfOwnerByIndex(ownerAddress, 1);
